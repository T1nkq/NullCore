...
namespace Voidstrap
{
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            try
            {
                using (Mutex.OpenExisting($"{App.ProjectName}-Bootstrapper"))
                {
                    App.Logger.WriteLine(LOG_IDENT, $"{App.ProjectName}-Bootstrapper mutex exists, waiting...");
            ...
            await using var mutex = new AsyncMutex(false, $"{App.ProjectName}-Bootstrapper");
