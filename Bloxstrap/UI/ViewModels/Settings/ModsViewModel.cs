...
namespace Voidstrap.UI.ViewModels.Settings
{
    public class ModsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async Task LoadModsAsync() // was working on this but idk fuc
        {
            ...
            http.DefaultRequestHeaders.UserAgent.ParseAdd($"{App.ProjectName}/{App.Version} (+https://github.com/{App.ProjectRepository})");
        ...
        {
            _http.DefaultRequestHeaders.UserAgent.ParseAdd($"{App.ProjectName}SkyboxClient/{App.Version}");
