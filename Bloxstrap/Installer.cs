...
namespace Voidstrap
{
    internal class Installer
    {
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs the app, closes it,
...
#pragma warning disable CS0162 // Unreachable code detected
                if (OpenReleaseNotes)
                    Utilities.ShellExecute($"https://github.com/{App.ProjectRepository}/wiki/Release-notes-for-{App.ProjectName}-v{currentVer}");
