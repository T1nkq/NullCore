namespace Voidstrap
{
    static class Paths
    {
        ...
        public static string RobloxBase { get; set; } = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), App.ProjectName);
        ...
        public static void Initialize(string baseDirectory, string? robloxBaseDirectory = null)
        {
            ...
            Mods = Path.Combine(Base, "NullCoreMods");
