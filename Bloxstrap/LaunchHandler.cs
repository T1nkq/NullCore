...
namespace Voidstrap
{
    public static class LaunchHandler
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Frontend.ShowMessageBox(
                        $"You are about to install a QA build of {App.ProjectName}. The red window border indicates that this is a QA build.\n\n" +
        ...
        public static void LaunchRoblox(LaunchMode launchMode)
        {
            ...
            {
                _ = Task.Run(RobloxFullscreen.WaitAndTriggerFullscreen); // redid https://github.com/T1nkq/NullCore/pull/362/changes/f0177af4ec39475a5b5c8ea5adc365dcdba0b0d9#diff-ed77fad50af3a8225af6d4c3e81af6095905805d31369da2b5d54f0c2382180e
            }
