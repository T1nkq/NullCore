...
namespace Voidstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "NullCore-QA";
#else
        public const string ProjectName = "NullCore";
#endif
        public const string ProjectOwner = "T1nkq";
        public const string ProjectRepository = "T1nkq/NullCore";
        ...
        public static void AssertWindowsOSVersion()
        {
            ...
            if (major < 7)
            {
                ...
                if (!LaunchSettings.QuietFlag.Active)
                    Frontend.ShowMessageBox($"Your Windows Version is not supported with {ProjectName}!", MessageBoxImage.Error);
