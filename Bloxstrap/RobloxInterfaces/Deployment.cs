...
namespace Voidstrap.RobloxInterfaces
{
    public static class Deployment
    {
        ...
        static Deployment()
        {
            SharedHttp.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", $"{App.ProjectName}Updater/2.0");
            ...
            DownloadForModGenerator(bool overwrite = false)
        {
            ...
            string tmp = Path.Combine(Path.GetTempPath(), App.ProjectName);
